...
include_once "vendor/autoload.php";  
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $single_data=$staffs->singleStaffsData($id);        
    } 
...
<head>
    ...
    <title><?php echo $single_data-> st_name;?></title>
    <link rel="stylesheet" href="assets/css/style.css">
    <link rel="stylesheet" href="assets/css/teacher-single-data.css">
                    ...
                    <div class="data-container">
                        <div class="students-data"> 
                            <div class="breadcrumb">
                                <div class="heading"><p>Staff Profile</p></div>  
                                <div class="breadcrumb-info">
                                    <p>Home > Stffs > All Staff> <span style="color:darkblue;"><?php echo $single_data-> st_name;?></span> </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-student-content">
                            <div class="single-student-info-1">
                                <div class="profile-view-photo">
                                    <img src="student_photo/<?php echo $single_data->st_photo?>" alt="">
                                    <h2><?php echo $single_data-> st_name;?></h2>
                                </div>
                                <div class="single-student-details">                                   
                                   
                                    <p><strong>Education </strong><span><?php echo $single_data-> education;?></span></p>
                                    <p><strong>Cell </strong> <span><?php echo $single_data-> st_cell;?></span> </p>
                                    <p><strong>Email ID </strong><span><?php echo $single_data-> st_email;?></span></p>
                                    
                                    <p><strong>Gender </strong><span><?php echo $single_data-> st_gender;?></span></p>
                                    <p><strong>Date of Birth </strong><span><?php echo $single_data->st_birth;?></span></p>
                                    <p><strong>Age </strong><span><?php echo $single_data-> age;?> Years</span></p>
                                    <p><strong>Designation </strong><span><?php echo $single_data->designation ;?></span></p>
                                    <p><strong>Joining date</strong><span><?php echo $single_data-> join_date;?></span></p>
                                ...
                                <div class="personal-info">
                                    ...
                                    <div class="personal-details">
                                        <div class="fname">
                                            ...
                                            <div class="item"><?php echo $single_data->fname;?></div>
                                        </div>
                                        <div class="fname">
                                        ...
                                        <div class="fname">
                                            <div class="item"><strong>Availability</strong> </div>
                                            <div class="item"><strong>:</strong> </div>
                                            <div class="item"><?php echo $single_data->availability;?></div>
                                        </div> 
                                        <div class="fname">
                                            <div class="item"><strong>Experience</strong> </div>
                                            <div class="item"><strong>:</strong> </div>
                                            <div class="item"><?php echo $single_data->experience;?></div>
                                        </div>                                                                         
                                        
                                        <div class="fname">
                                            <div class="item"><strong>Present Address</strong> </div>
                                            <div class="item"><strong>:</strong> </div>
                                            <div class="item"><?php echo $single_data->pre_location;?></div>
                                        </div>
                                        <div class="fname">
                                            <div class="item"><strong>Permenent Address</strong> </div>
                                            <div class="item"><strong>:</strong> </div>
                                            <div class="item"><?php echo $single_data->per_location;?></div>
                                        </div>
                                        <div class="details">
                                            <div class="item"><strong>About me :</strong></div>
