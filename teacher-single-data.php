...
include_once "vendor/autoload.php";  
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $single_data=$teacher->singleTeacherData($id);        
    } 
...
<head>
    ...
    <title><?php echo $single_data-> tname;?></title>
                    ...
                    <div class="data-container">
                        <div class="students-data"> 
                            <div class="breadcrumb">
                                <div class="heading"><p>Teacher Profile</p></div>  
                                <div class="breadcrumb-info">
                                    <p>Home > Teachers > All Teacher > <span style="color:darkblue;"><?php echo $single_data-> tname;?></span> </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="single-student-content">
                            <div class="single-student-info-1">
                                <div class="profile-view-photo">
                                    <img src="student_photo/<?php echo $single_data->tphoto?>" alt="">
                                    <h2><?php echo $single_data-> tname;?></h2>
                                </div>
                                <div class="single-student-details">                                   
                                   
                                    <p><strong>Education </strong><span><?php echo $single_data-> education;?></span></p>
                                    <p><strong>Cell </strong> <span><?php echo $single_data-> tcell;?></span> </p>
                                    <p><strong>Email ID </strong><span><?php echo $single_data-> temail;?></span></p>
                                    
                                    <p><strong>Gender </strong><span><?php echo $single_data-> tgender;?></span></p>
                                    <p><strong>Date of Birth </strong><span><?php echo $single_data->tbirth;?></span></p>
