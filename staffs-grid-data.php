...
<head>
    ...
    <link rel="stylesheet" href="assets/css/grid-staff-data.css">
                            ...
                            <div class="grid-info">
                                <div class="edit-delete">
                                    ...
                                    <div class="edit-delete-toggle">
                                        <a href="edit-staff-data.php?id=<?php echo $id-> id;?>">Edit</a>
                                ...
                                <div class="grid-photo">                               
                                    <div class="img">                                    
                                        <img src="student_photo/<?php echo $id->st_photo?>" alt="">
                                    </div>
                                    <div class="name">
                                        <h2><?php echo $id->st_name?></h2>
                                    </div>
                                </div>
                                <div class="grid-info-container">
                                    ...
                                    <div class="phone">
                                        ...
                                        <span><?php echo $id->st_cell?></span>
                                    </div>
                                    <div class="email">
                                        <span> <strong>Email :</strong></span>
                                        <span><?php echo $id->st_email?></span>
                                    </div>
                                    ...
                                    <div class="btn">
                                        <a href="staff-single-data.php?id=<?php echo $id-> id;?>">Read more</a>
                                    </div>
                                </div>
