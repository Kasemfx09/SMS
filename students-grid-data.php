                            ...
                            <ul class="navbar-nav">                                                  
                                ...
                                <li class="nav-item"><a class="nav-ink toggle" href=""><i class="fas fa-user-tie"></i>Teachers</a>
                                    <ul class="inner">
                                        ...
                                        <li class="inner-item"><a href="">Edit Professors</a></li>
                                    </ul> 
                                </li>
                                ...
                                <div class="data-heading">
                                    <div class="heading-button">
                                        <ul>
                                            ...
                                            <a href="students-data.php">Grid View</a>
                                        </ul>                                       
                                    </div>  
                                    <div class="search">
                                        <form action="" method="POST">
                            ...
                            <div class="grid-info">
                                <div class="edit-delete">
                                    ...
                                    <div class="edit-delete-toggle">
                                        <a href="edit-student-data.php?id=<?php echo $id-> id;?>">Edit</a>
                                ...
                                <div class="grid-photo">                               
                                    <div class="img">                                    
                                        <img src="student_photo/<?php echo $id->photo?>" alt="">
                                    </div>
                                    <div class="name">
                                        <h2><?php echo $id->sname?></h2>
                                    </div>
                                </div>
                                <div class="grid-info-container">
                                    ...
                                    <span> <strong>Class :</strong></span>
                                        <span><?php echo $id->class?></span>
                                    </div>
                                    <div class="roll">
                                        <span> <strong>Roll no. :</strong></span>
                                        <span><?php echo $id->roll?></span>
                                    </div>
                                    <div class="phone">
                                        <span> <strong>Phone :</strong></span>
                                        <span><?php echo $id->scell?></span>
                                    </div>
                                    <div class="email">
                                        <span> <strong>Email :</strong></span>
                                        <span><?php echo $id->email?></span>
                                    </div>
                                    <div class="admission-date">
                                        <span> <strong>Admission Date :</strong></span>
                                        <span><?php echo $id->admission_date?></span>
                                    </div>
                                    <div class="btn">
                                        <a href="student-single-data.php?id=<?php echo $id-> id;?>">Read more</a>
                                    </div>
                                </div> 
