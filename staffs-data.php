...
<head>
    ...
    <link rel="stylesheet" href="assets/css/staffs-data.css">
                    ...
                    <div class="data-container">
                        <div class="students-data"> 
                            <div class="breadcrumb">
                                <div class="heading"><p>All Staffs List</p></div>  
                                <div class="breadcrumb-info">
                                    <p>Home > Staffs > All Staffs</p>
                                </div>
                            </div>                                  
                            ...
                            <!--********** Table heading **********-->
                                ...
                                <div class="data-heading">
                                    <div class="heading-button">
                                        <ul>
                                            <a href="staffs-data.php">List View</a>
                                            <a href="staffs-grid-data.php">Grid View</a>
                                        </ul>                                        
                                    </div>  
                                    <div class="search">
                                        <form action="" method="POST">
                            ...
                            <div class="students-content">
                                <div class="students-info">
                                    <table>
                                        ...
                                        <tr>
                                            <td><?php echo $i; $i++?></td>
                                            <td><?php echo $id->st_name;?></td>
                                            <td><?php echo $id->st_cell;?></td>
                                            <td><?php echo $id->st_email;?></td>
                                            <td><?php echo $id->st_gender;?></td>
                                            <td><?php echo $id->age;?></td>
                                            <td><?php echo $id->education;?></td>
                                            <td><?php echo $id->salary;?></td>
                                            <td><?php echo $id->pre_location;?></td>   
                                            <td><div class="photo"><img src="student_photo/<?php echo $id->st_photo?>" alt="photo"></div> </td>                      
                                            <td class="view">
                                                <a class="tooltiptext" >View</a>
                                                <a href="staff-single-data.php?id=<?php echo $id-> id;?>" ><i class="far fa-eye"></i></a>
                                            </td>
                                            <td class="view">
                                                <span class="tooltiptext">Edit</span>
                                                <a href="edit-staff-data.php?id=<?php echo $id-> id;?>"><i class="fas fa-pen"></i></a>
                                            </td>
                                            <td class="view">
