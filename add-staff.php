...
if(isset($_POST['add'])){
    ...
    if(empty($st_name) && empty($st_cell) && empty($st_email) &&empty($age) && empty($education) && empty($salary) && empty($st_gender)){      
        ...
        $msg_email=Validate::required('Required valid email number!');
            ...
            $staff->StaffCreate($st_name, $st_cell, $st_email, $st_birth, $age, $department, $education, $st_gender, $salary, $join_date, $fname, $mname, $pre_location, $per_location);
                                    ...
                                    <div class="update-container">
                                        <div class="update-column-1">                                         
                                            <div class="name update-item">
                                                ...
                                                <input class="border" type="text" name="st_name" placeholder="Staff Name" value="">
                                            </div>

                                            <div class="cell update-item">
                                                <label for="">Cell Number <strong style="color:red;">*</strong></label>                                               
                                                <input class="border" type="text" name="st_cell" placeholder="Cell Number" value="">
                                                <?php echo $msg_cell ?? '';?>
                                            </div>
                                            <div class="email update-item">
                                                <label for="">Email <strong style="color:red;">*</strong></label>                                                
                                                <input class="border" class="border" type="text" name="st_email" placeholder="Email" value="">
                                                <?php echo $msg_email ?? '';?>
                                            </div>
                                        </div>
                                        <div class="update-column-2">                                           
                                            <div class="birth update-item">
                                                ...
                                                <input class="border" type="text" name="st_birth" placeholder="DD/MM/YYYY" value="">
                                            </div>                             
                                            ...
                                            <div class="gender update-item">
                                                ...
                                                <span class="border-gender" >
                                                    <div class="gender-fit">
                                                        ...
                                                        <input type="radio" id="male" name="st_gender" value="Male">
                                                    </div>
                                                    <div class="gender-fit">
                                                        <label for="female">Female</label>
                                                        <input type="radio" id="female" name="st_gender" value="Female">
                                                    </div>
                                                </span>
                                            </div>
                                        ...
                                        <div class="address">                                        
                                            ...
                                            <label for="">Present Address <strong style="color:red;">*</strong></label>
                                                <textarea class="border" name="pre_location" id=""></textarea>
                                            </div>
                                            <div class="permenent_address">
                                            <label for="">Permenent Address</label>
                                                <textarea class="border" name="per_location" id=""></textarea>
                                            </div>
                                        </div>                                        
                                    </div> 
                                     <div class="photo">  
