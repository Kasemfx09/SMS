...
<head>
    ...
    <link rel="stylesheet" href="assets/css/teachers-data.css">
                        ...
                        <div class="navbar">
                            <ul class="navbar-nav">                                                  
                                ...
                                <li class="nav-item"><a class="nav-ink toggle" href=""><i class="fas fa-user-tie"></i>Teachers</a>
                                    <ul class="inner">
                                        <li class="inner-item"><a href="">All Teachers</a></li>
                        ...
                        <div class="students-data"> 
                            <div class="breadcrumb">
                                ...
                                <div class="breadcrumb-info">
                                    <p>Home > Teachers > All Teachers</p>
                                </div>
                            </div>                                  
                            ...
                            <!--********** Table heading **********-->
                                ...
                                <div class="data-heading">
                                    <div class="heading-button">
                                        <ul>
                                            <a href="teacher-data.php">List View</a>
                            ...
                            <div class="students-content">
                                <div class="students-info">
                                    <table>
                                        ...
                                        <tr>
                                            <td><?php echo $i; $i++?></td>
                                            <td><?php echo $id->tname;?></td>
                                            <td><?php echo $id->tcell;?></td>
                                            <td><?php echo $id->temail;?></td>
                                            <td><?php echo $id->tgender;?></td>
                                            <td><?php echo $id->age;?></td>
                                            <td><?php echo $id->education;?></td>
                                            <td><?php echo $id->salary;?></td>
                                            <td><?php echo $id->pre_address;?></td>   
                                            <td><div class="photo"><img src="student_photo/<?php echo $id->tphoto?>" alt="photo"></div> </td>                      
                                            <td class="view">
                                                <a class="tooltiptext" >View</a>
                                                <a href="teacher-single-data.php?id=<?php echo $id-> id;?>" ><i class="far fa-eye"></i></a>
                                            </td>
                                            <td class="view">
                                                <span class="tooltiptext">Edit</span>
                                                <a href="edit-teacher-data.php?id=<?php echo $id-> id;?>"><i class="fas fa-pen"></i></a>
                                            </td>
                                            <td class="view">
